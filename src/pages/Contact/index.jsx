          ...
          <div className="max-w-[1250px] mx-auto">
            <div className="py-20 px-3">
              <motion.h1
                ...
                className="text-5xl font-bold bg-clip-text text-transparent text-center bg-gradient-to-r from-purple-400 to-pink-600 mb-4"
              >
                Get In Touch
              </motion.h1>
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8 }}
                className="text-gray-300 max-w-2xl text-center mx-auto mb-6"
              >
              ...
              <div className="flex justify-center items-center">
                <form
                  ref={form}
                  onSubmit={sendEmail}
                  className="bg-[#19142D] rounded-lg border border-purple-500/50 py-8 px-5 w-[600px]"
                >
                  <motion.label
                    initial={{ opacity: 0, y: 20 }}
